...
const CondominiumPropertyValuationSchema = z.object({
  property_type: z
    .string({
  ...
  enable_initial_price: z
    .boolean({
      description: 'Enable initial price.',
      required_error: 'Enable initial price is required.',
      invalid_type_error: 'Enable initial price must be a boolean.',
    })
    .default(false),
});
